...
attention_per_proba = data_for_plot.groupby('prob_option_A')['dwell_time_absolute']
...
plt.bar(['first', 'second', 'third', 'fourth'], [first_case['dwell_time_absolute'].mean(), second_case['dwell_time_absolute'].mean(), 
                                               third_case['dwell_time_absolute'].mean(), fourth_case['dwell_time_absolute'].mean()], 
        color = ['dimgray', 'darkgray', 'silver', 'lightgrey']) 
plt.errorbar(['first', 'second', 'third', 'fourth'], 
             [first_case['dwell_time_absolute'].mean(), second_case['dwell_time_absolute'].mean(), third_case['dwell_time_absolute'].mean(), fourth_case['dwell_time_absolute'].mean()], 
              [first_case['dwell_time_absolute'].std(), second_case['dwell_time_absolute'].std(), third_case['dwell_time_absolute'].std(), fourth_case['dwell_time_absolute'].std()], 
              ecolor = 'black', fmt='none', alpha=0.7, label = 'std ind level')
plt.xlabel('Case order')
plt.ylabel('Mean attention in %')
plt.title('Mean attention per case order ABSOLUTE')
plt.savefig('Attention case order ABSOLUTE H2.png', dpi=1200)
plt.show()
...
plt.ylabel('Mean attention in %')
plt.title('Mean attention per probability for all ABSOLUTE')
plt.savefig('Attention probability ABSOLUTE H2.png', dpi=1200)
plt.show()
...
for i in self_lottery_attention['number'].unique():
    individual = self_lottery_attention.loc[self_lottery_attention['number'] == i, ['case', 'prob_option_A', 'dwell_time_absolute']] 
    individual_difference = individual.pivot(index='prob_option_A', columns='case', values='dwell_time_absolute')
...
for i in charity_lottery_attention['number'].unique():
    individual = charity_lottery_attention.loc[charity_lottery_attention['number'] == i, ['case', 'prob_option_A', 'dwell_time_absolute']] 
    individual_difference = individual.pivot(index='prob_option_A', columns='case', values='dwell_time_absolute')
...
for i in no_tradeoff_lottery_attention['number'].unique():
    individual = no_tradeoff_lottery_attention.loc[no_tradeoff_lottery_attention['number'] == i, ['case', 'prob_option_A', 'dwell_time_absolute']] 
    individual_difference = individual.pivot(index='prob_option_A', columns='case', values='dwell_time_absolute')
    try: 
...
for i in self_lottery_attention_censored['number'].unique():
    individual = self_lottery_attention_censored.loc[self_lottery_attention_censored['number'] == i, ['case', 'prob_option_A', 'dwell_time_absolute']] 
    individual_difference = individual.pivot(index='prob_option_A', columns='case', values='dwell_time_absolute')
    individual_difference['dwell_time_ACPS_ASPS'] = individual_difference['ACPS'] - individual_difference['ASPS']
    individual_difference['number'] = i
    individual_difference.reset_index(inplace=True)
...
for i in charity_lottery_attention_censored['number'].unique():
    individual = charity_lottery_attention_censored.loc[charity_lottery_attention_censored['number'] == i, ['case', 'prob_option_A', 'dwell_time_absolute']] 
    individual_difference = individual.pivot(index='prob_option_A', columns='case', values='dwell_time_absolute')
    individual_difference['dwell_time_ASPC_ACPC'] = individual_difference['ASPC'] - individual_difference['ACPC']
    individual_difference['number'] = i
    individual_difference.reset_index(inplace=True)
...
for i in no_tradeoff_lottery_attention_censored['number'].unique():
    individual = no_tradeoff_lottery_attention_censored.loc[no_tradeoff_lottery_attention_censored['number'] == i, ['case', 'prob_option_A', 'dwell_time_absolute']] 
    individual_difference = individual.pivot(index='prob_option_A', columns='case', values='dwell_time_absolute')
    individual_difference['dwell_time_ACPC_ASPS'] = individual_difference['ACPC'] - individual_difference['ASPS']
    individual_difference['number'] = i
    individual_difference.reset_index(inplace=True)
...
attention_per_proba_censored = data_censored.groupby('prob_option_A')['dwell_time_absolute']

plt.bar(['0.05', '0.1', '0.25', '0.5', '0.75', '0.9', '0.95'], attention_per_proba_censored.mean(), 
        color = ['darkgoldenrod', 'goldenrod', 'gold', 'khaki', 'beige', 'papayawhip', 'peachpuff']) 
plt.xlabel('Probability')
plt.ylabel('Mean atention time in %')
plt.title('Mean attention per probability for Censored ABSOLUTE')
plt.savefig('Attention probability CENSORED ABSOLUTE H2.png', dpi=1200)
plt.show()
...
plt.title('Difference in attention across probabilities for Censored ABSOLUTE')
plt.savefig('Bar diff type Lottery CENSORED ABSOLUTE H2.png', dpi=1200)
plt.show()
...
plt.errorbar(['$A^{C}(P^{C})-A^{S}(P^{S}$)', '$A^{C}(P^{S})-A^{S}(P^{S})$', '$A^{S}(P^{C})-A^{C}(P^{C})$'], 
              [no_tradeoff_lottery_differences_attention_ALL['dwell_time_ACPC_ASPS'].mean(), 
               self_lottery_differences_attention_ALL['dwell_time_ACPS_ASPS'].mean(), 
               charity_lottery_differences_attention_ALL['dwell_time_ASPC_ACPC'].mean()], 
              [0.109, 0.124, 0.1465], ecolor = 'black', fmt='none', alpha=0.7)
plt.axhline(y=0, color='grey', linestyle='--')
plt.ylim(-1, 0.25)
plt.xlabel('Lottery type')
plt.ylabel('Difference in attention (trad - no trad) in %')
plt.title('Difference in attention across probabilities for EDRP and Censored ABSOLUTE updated')
plt.savefig('Bar diff type Lottery EDRP + CENSORED ABSOLUTE H2.png', dpi=1200)
plt.show()
...
# Plot Attention absolute

# error_attention_absolute = [np.std(ASPS['dwell_time_absolute']), np.std(ACPS['dwell_time_absolute']), 
#                   np.std(ACPC['dwell_time_absolute']), np.std(ASPC['dwell_time_absolute'])]

# mean_attentions_absolute = [ASPS.groupby('prob_option_A')['dwell_time_absolute'].mean().mean(), 
#                             ACPS.groupby('prob_option_A')['dwell_time_absolute'].mean().mean(),
#                             ACPC.groupby('prob_option_A')['dwell_time_absolute'].mean().mean(),
#                             ASPC.groupby('prob_option_A')['dwell_time_absolute'].mean().mean()]

# plt.bar(['$A^{S}(P^{S})$', '$A^{C}(P^{S})$', '$A^{C}(P^{C})$', '$A^{S}(P^{C})$'], mean_attentions_absolute, color = ['blue', 'dodgerblue', 'green', 'limegreen']) 
# plt.errorbar(['$A^{S}(P^{S})$', '$A^{C}(P^{S})$', '$A^{C}(P^{C})$', '$A^{S}(P^{C})$'], mean_attentions_absolute, error_attention_absolute, ecolor = 'black', fmt='none', alpha=0.5, label='std')
# plt.xlabel('Case')
# plt.ylabel('Mean attention in s')
# plt.title('Attention per case, across probabilities ABSOLUTE')
# plt.legend()
# plt.savefig('Bar all Lottery ABSOLUTE H2.png', dpi=1200)
# plt.show()


# EDRP
# error_attention_absolute_EDRP = [np.std(ASPS_EDRP['dwell_time_absolute']), np.std(ACPS_EDRP['dwell_time_absolute']), 
#                   np.std(ACPC_EDRP['dwell_time_absolute']), np.std(ASPC_EDRP['dwell_time_absolute'])]

# mean_attentions_absolute_EDRP = [ASPS_EDRP.groupby('prob_option_A')['dwell_time_absolute'].mean().mean(), 
#                             ACPS_EDRP.groupby('prob_option_A')['dwell_time_absolute'].mean().mean(),
#                             ACPC_EDRP.groupby('prob_option_A')['dwell_time_absolute'].mean().mean(),
#                             ASPC_EDRP.groupby('prob_option_A')['dwell_time_absolute'].mean().mean()]

# plt.bar(['$A^{S}(P^{S})$', '$A^{C}(P^{S})$', '$A^{C}(P^{C})$', '$A^{S}(P^{C})$'], mean_attentions_absolute_EDRP, color = ['blue', 'dodgerblue', 'green', 'limegreen']) 
# plt.errorbar(['$A^{S}(P^{S})$', '$A^{C}(P^{S})$', '$A^{C}(P^{C})$', '$A^{S}(P^{C})$'], mean_attentions_absolute_EDRP, error_attention_absolute_EDRP, ecolor = 'black', fmt='none', alpha=0.5, label='std')
# plt.xlabel('Case')
# plt.ylabel('Mean attention in s')
# plt.title('Attention per case, across probabilities for EDRP subjects ABSOLUTE')
# plt.legend()
# plt.savefig('Bar all Lottery EDRP ABSOLUTE H2.png', dpi=1200)
# plt.show()
...
plt.xlabel('Lottery type')
plt.ylabel('Difference in attention (trad - no trad) in %')
plt.title('Difference in attention across probabilities ABSOLUTE H2')
plt.legend()
plt.savefig('Bar diff type Lottery ABSOLUTE H2.png', dpi=1200)
plt.show()
...
plt.xlabel('Lottery type')
plt.ylabel('Difference in attention (trad - no trad) in %')
plt.title('Difference in attention for EDRP subjects H2 ABSOLUTE')
plt.legend()
plt.savefig('Bar diff type Lottery EDRP ABSOLUTE H2.png', dpi=1200)
plt.show()
...
plt.xlabel('Lottery type')
plt.ylabel('Difference in attention (trad - no trad) in %')
plt.title('Difference in attention for altruistic subjects ABSOLUTE H2')
plt.legend()
plt.savefig('Bar diff type Lottery Altruistic ABSOLUTE H2.png', dpi=1200)
plt.show()
...
censored_errors = [0.167, 0.189, 0.210]
...
plt.xlabel('Lottery type')
plt.ylabel('Difference in attention (trad - no trad) in %')
plt.title('Difference in attention for Adaptive and Censored subjects ABSOLUTE H2 updated')
...
plt.savefig('Merged Attention Adapted and Censored ABSOLUTE.png', dpi=1200)
plt.show()
...
# plt.xlabel('Lottery type')
# plt.ylabel('Difference in attention (trad - no trad) in %')
# plt.title('Difference in attention for NO EDRP subjects ABSOLUTE H2')
# plt.savefig('Bar diff type Lottery NO EDRP ABSOLUTE H2.png', dpi=1200)
# plt.show()
...
# plt.hist(data_for_plot['dwell_time_absolute'], bins=50)
# plt.xlabel('Attention en s')
# plt.ylabel('Frequence')
# plt.title('Histo attention')
# plt.show()
...
# ALL 
# average_attention_ASPS = ASPS.groupby('prob_option_A')['dwell_time_absolute'].mean()
# average_attention_ACPC = ACPC.groupby('prob_option_A')['dwell_time_absolute'].mean()
# average_attention_ACPS = ACPS.groupby('prob_option_A')['dwell_time_absolute'].mean()
# average_attention_ASPC = ASPC.groupby('prob_option_A')['dwell_time_absolute'].mean()
...
# plt.ylabel('Mean Attention in %')
# plt.title('Mean Attention per probability ABSOLUTE')
# plt.grid(True)
# plt.legend()
# plt.savefig('Proba attention diff ALL ABSOLUTE H2.png', dpi=1200)
# plt.show()
...
# average_attention_ASPS_EDRP = ASPS_EDRP.groupby('prob_option_A')['dwell_time_absolute']
# average_attention_ACPC_EDRP = ACPC_EDRP.groupby('prob_option_A')['dwell_time_absolute']
# average_attention_ACPS_EDRP = ACPS_EDRP.groupby('prob_option_A')['dwell_time_absolute']
# average_attention_ASPC_EDRP = ASPC_EDRP.groupby('prob_option_A')['dwell_time_absolute']
...
# plt.xlabel('Probability P of Non-Zero Payment')
# plt.ylabel('Mean Attention in %')
# plt.title('Mean Attention per probability EDRP ABSOLUTE')
# plt.grid(True)
# plt.legend()
# plt.savefig('Proba attention diff EDRP ABSOLUTE H2.png', dpi=1200)
# plt.show()

# # Censored  
# average_attention_ASPS_censored = ASPS_censored.groupby('prob_option_A')['dwell_time_absolute']
# average_attention_ACPC_censored = ACPC_censored.groupby('prob_option_A')['dwell_time_absolute']
# average_attention_ACPS_censored = ACPS_censored.groupby('prob_option_A')['dwell_time_absolute']
# average_attention_ASPC_censored = ASPC_censored.groupby('prob_option_A')['dwell_time_absolute']
...
# plt.grid(True)
# plt.legend()
# plt.savefig('Proba attention diff Censored ABSOLUTE H2.png', dpi=1200)
# plt.show()
...
# plt.title('Difference in valuation across probabilities ABSOLUTE')
# plt.legend()
# plt.savefig('Histo Valuation diff ABSOLUTE H1.png', dpi=1200)
# plt.show()
...
plt.xlabel('Probability P of Non-Zero Payment')
plt.ylabel('Difference in attention (trad - no trad) in %')
plt.title('Attentional differences for principal analysis ABSOLUTE')
plt.legend()
plt.savefig('Attention across proba Lottery difference ALL ABSOLUTE H2.png', dpi=1200)
plt.show()
...
plt.xlabel('Probability P of Non-Zero Payment')
plt.ylabel('Difference in attention (trad - no trad) in %')
plt.title('Attentional differences for Excuse-driven subjects ABSOLUTE')
plt.legend()
plt.savefig('Attention across proba Lottery difference EDRP ABSOLUTE H2.png', dpi=1200)
plt.show()
...
plt.xlabel('Probability P of Non-Zero Payment')
plt.ylabel('Difference in attention (trad - no trad) in %')
plt.title('Attentional differences for Altruistic subjects ABSOLUTE')
plt.legend()
plt.savefig('Attention across proba Lottery difference Altruistic ABSOLUTE H2.png', dpi=1200)
plt.show()
...
plt.xlabel('Probability P of Non-Zero Payment')
plt.ylabel('Difference in attention (trad - no trad) in %')
plt.title('Attentional differences for Censored subjects ABSOLUTE')
plt.legend()
plt.savefig('Attention across proba Lottery difference CENSORED ABSOLUTE H2.png', dpi=1200)
plt.show()
...
plt.xlabel('Probability P of Non-Zero Payment')
plt.ylabel('Difference in attention (trad - no trad) in %')
plt.title('Attentional differences for Excuse-driven and Censored subjects ABSOLUTE')
plt.legend()
plt.savefig('Attention across proba Lottery difference EDRP + CENSORED ABSOLUTE H2.png', dpi=1200)
plt.show()
...
y_2 = data_for_analysis['dwell_time_absolute']
...
# Same process but now dwell_time as dependent variable
y_2_EDRP = data_for_analysis_EDRP['dwell_time_absolute']
...
# Same process but now dwell_time as dependent variable
y_2_altruistic = data_for_analysis_altruistic['dwell_time_absolute']
...
# Same process but now dwell_time as dependent variable
y_2_no_EDRP = data_for_analysis_no_EDRP['dwell_time_absolute']
...
# Same process but now dwell_time as dependent variable
y_2_censored = data_for_analysis_censored['dwell_time_absolute']
...
# Same process but now dwell_time as dependent variable
y_2_all_and_censored = data_for_analysis_all_and_censored['dwell_time_absolute']
...
# Same process but now dwell_time as dependent variable
y_2_EDRP_and_censored = data_for_analysis_EDRP_and_censored['dwell_time_absolute']
...
# Mixed effects
md_2 = smf.mixedlm("dwell_time_absolute ~ charity + tradeoff + interaction", data_for_analysis, groups=data_for_analysis["number"])
mdf_2 = md_2.fit()
print(mdf_2.summary())

md_3 = smf.mixedlm("dwell_time_absolute ~ case_order", data_for_analysis, groups=data_for_analysis["number"])
mdf_3 = md_3.fit()
print(mdf_3.summary())

md_4 = smf.mixedlm("dwell_time_absolute ~ prob_option_A", data_for_analysis, groups=data_for_analysis["number"])
mdf_4 = md_4.fit()
print(mdf_4.summary())
