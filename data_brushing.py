...
path_0 = '/Users/carolinepioger/Desktop/EXLEY ATT' # change to yours
path = path_0 + '/raw_data' # paths to the raw data
...
path2 = path_0 + '/Exley_attentional/data' # saving the brushed up data in the data folder of the main folder
